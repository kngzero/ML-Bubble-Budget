...
import { daysBetween, addInterval, monthlyEquivalent, dueColor, parseHue, packCircles } from '../src/lib/utils.js'
...
expect(Math.abs(monthlyEquivalent(10,'weekly') - 43.4524)).toBeLessThan(1e-6)
expect(Math.abs(monthlyEquivalent(120,'yearly') - 10)).toBeLessThan(1e-6)
expect(Math.abs(monthlyEquivalent(10,'custom',10) - 30)).toBeLessThan(1e-6)
})
...
const layout = [ {id:'a', r:40}, {id:'b', r:35}, {id:'c', r:28}, {id:'d', r:24}, {id:'e', r:20} ]
